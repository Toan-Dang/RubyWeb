...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { firtname: @test.firtname, last_name: @test.last_name } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { firtname: @test.firtname, last_name: @test.last_name } }
